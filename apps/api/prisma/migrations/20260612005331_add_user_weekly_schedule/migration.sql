...
INSERT INTO "new_User" ("avatar", "businessId", "commissionPct", "createdAt", "email", "id", "name", "password", "phone", "role", "updatedAt", "workDays") SELECT "avatar", "businessId", "commissionPct", "createdAt", "email", "id", "name", "password", "phone", "role", "updatedAt", "workDays" FROM "User";
DROP TABLE "User";
